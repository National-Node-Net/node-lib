...
from ianode_lib.middleware.decode_token import AccessMiddleware
...
class DecodeTokenTestCase(unittest.TestCase):
    ...
    @mock.patch('ianode_lib.middleware.decode_token.jwt')
    ...
    @mock.patch('ianode_lib.middleware.decode_token.requests')
    @mock.patch('ianode_lib.middleware.decode_token.jwt')
