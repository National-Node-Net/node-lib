...
from ianode_lib import AutomaticAdapter, Mapper, Projector, Record
from ianode_lib.errors import ErrorHandler, ErrorLevel
...
class ErrorHandlerUseCaseTestCase(ErrorHandlerTestCaseStub):
    ...
    @mock.patch('ianode_lib.errors.ErrorHandler.send_exception')
