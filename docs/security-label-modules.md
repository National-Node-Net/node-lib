...
It is important to note that node-lib does not enforce any of these operations; 
...
an implementation of the IANodeModel. label-builder is not a dependency of node-lib.
...
data_header_model = IANodeModel(**data_header)
